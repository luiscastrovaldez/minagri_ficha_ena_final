...
public class ModuloECapitulo5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modulo_e_capitulo5);
        ...
        guardar = (FloatingActionButton) findViewById(R.id.guardar5e);
        salir = (FloatingActionButton) findViewById(R.id.salirLoteCapitulo5e);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(ModuloECapitulo5Activity.this)
    ...
    private void guardarFormulario() {
        ...
        LinearLayout layout = findViewById(R.id.noduloecapitulo5);
