...
public class ModuloCCapitulo5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modulo_c_capitulo5);
        ...
        guardar = (FloatingActionButton) findViewById(R.id.guardar5c);
        salir = (FloatingActionButton) findViewById(R.id.salirLoteCapitulo5c);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(ModuloCCapitulo5Activity.this)
    ...
    private void guardarFormulario() {
        ...
        LinearLayout layout = findViewById(R.id.noduloccapitulo5);
