...
public class ModuloHCapitulo5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modulo_h_capitulo5);
        ...
        guardar = (FloatingActionButton) findViewById(R.id.guardar5h);
        salir = (FloatingActionButton) findViewById(R.id.salirLoteCapitulo5h);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(ModuloHCapitulo5Activity.this)
    ...
    private void guardarFormulario() {
        ...
        LinearLayout layout = findViewById(R.id.nodulohcapitulo5);
