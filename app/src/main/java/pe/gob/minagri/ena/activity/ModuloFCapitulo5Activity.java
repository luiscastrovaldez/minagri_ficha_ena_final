...
public class ModuloFCapitulo5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modulo_f_capitulo5);
        ...
        guardar = (FloatingActionButton) findViewById(R.id.guardar5f);
        salir = (FloatingActionButton) findViewById(R.id.salirLoteCapitulo5f);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(ModuloFCapitulo5Activity.this)
    ...
    private void guardarFormulario() {
        ...
        LinearLayout layout = findViewById(R.id.nodulofcapitulo5);
