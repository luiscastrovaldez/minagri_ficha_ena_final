...
public class ModuloDCapitulo5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modulo_d_capitulo5);
        ...
        guardar = (FloatingActionButton) findViewById(R.id.guardar5d);
        salir = (FloatingActionButton) findViewById(R.id.salirLoteCapitulo5d);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(ModuloDCapitulo5Activity.this)
    ...
    private void guardarFormulario() {
        ...
        LinearLayout layout = findViewById(R.id.nodulodcapitulo5);
