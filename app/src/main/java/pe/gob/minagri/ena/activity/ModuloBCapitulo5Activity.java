...
public class ModuloBCapitulo5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modulo_b_capitulo5);
        ...
        guardar = (FloatingActionButton) findViewById(R.id.guardar5b);
        salir = (FloatingActionButton) findViewById(R.id.salirLoteCapitulo5b);
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog alertDialog = new AlertDialog.Builder(ModuloBCapitulo5Activity.this)
    ...
    private void guardarFormulario() {
        ...
        LinearLayout layout = findViewById(R.id.nodulobcapitulo5);
